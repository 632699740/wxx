					...
					<div class="gray_box">
						<div class="box">
							<table class="form_table">
								...
								<col />
								<tr>
									<th>数据库地址</th><td><input class="gray" type="text" name='db_address' value='localhost' /><br /><label>MYSQL数据库的地址，本地默认：localhost</label></td>
								</tr>
                                <tr>
                                    <th>端口号</th><td><input class="gray" type="text" name='db_nmb' value='3306' /><br /><label>MYSQL数据库的端口，本地默认:3306</label></td>
                                </tr>
								<tr>
								...
								<tr>
									<th>数据库表前缀</th>
									<td><input class="gray" type="text" value='wx_' name='db_pre' /><br /><label class="error" id='db_pre_label' style='display:none'><img src="images/failed.gif" width="16" height="15" />请填写正确的表前缀字符</label></td>
								</tr>
								<tr>
