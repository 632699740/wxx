...
<aside class="sidebar">
    <div id="leftside-navigation" class="nano">
        <ul class="nano-content">
            <li class="active">
                <a href="#"><i class="fa fa-dashboard"></i><span>菜单</span></a>
            </li>
            <li class="sub-menu">
                <a href="javascript:void(0);"><i class="fa fa-cogs"></i><span>公众号管理</span><i class="arrow fa
                    fa-angle-right pull-right"></i></a>
                <ul>

                    <li><a href="index.php?r=index/form">添加公众号</a>
                    </li>
                    <li><a href="index.php?r=index/tables">公众号列表</a>
                    </li>
                    <li><a href="index.php?r=index/menu">菜单管理</a>
                    </li>
                    <li><a href="">自定义回复</a>
                    </li>
