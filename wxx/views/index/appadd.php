...
<!--                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <form class="form-horizontal" role="form" method="post" action="index.php?r=index/add">
                                <div class="form-group">
                                    <label for="inputEmail2" class="col-sm-2 control-label">appID</label>
                                    <div class="col-sm-10">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="info" class="form-control" placeholder="描述你微信用途">
                                    </div>
                                </div>
